...
Members:
- Product Requirements Agent — agent, role: "Product Requirements" — skills: document-to-action-items, grounded-citations, ideation, meeting-action-items, prototype, sketch, to-questionnaire, to-spec, to-tickets, writing-plans — `[@Product Requirements Agent](mention://agent/8b6dc9a0-75f9-402c-82d3-5971a31aeb02)`
- UX Information Architecture Agent — agent, role: "UX & Information Architecture" — skills: architecture-diagram, claude-design, design-md, excalidraw, popular-web-designs, prototype, sketch, writing-plans — `[@UX Information Architecture Agent](mention://agent/b1599c5e-0059-437e-a128-44898ba07f9c)`
- UI Design System Agent — agent, role: "UI & Design System" — skills: claude-design, design-md, excalidraw, p5js, popular-web-designs, pretext, prototype, sketch — `[@UI Design System Agent](mention://agent/04b61011-236f-4d30-8928-6f02f4b85c3b)`
- Frontend Engineer Agent — agent, role: "Frontend Engineer" — skills: claude-design, codebase-cleanup, codebase-documentation, design-md, local-webapp-verification, popular-web-designs, requesting-code-review, setup-pre-commit, simplify-code, sketch, systematic-debugging, tdd, test-driven-development — `[@Frontend Engineer Agent](mention://agent/6d68f0f5-1d1e-4c53-98dc-a3424e27b06d)`
- Backend API Agent — agent, role: "Backend & API" — skills: architecture-diagram, codebase-cleanup, codebase-documentation, cron-job-patterns, laravel-docker-dev, laravel-docker-skeleton, local-webapp-verification, node-inspect-debugger, python-debugpy, requesting-code-review, server-automation, simplify-code, systematic-debugging, tdd, test-driven-development, webhook-subscriptions — `[@Backend API Agent](mention://agent/a581b6a2-a2f4-450e-b531-ff658eca1823)`
- Database Agent — agent, role: "Database" — skills: architecture-diagram, data-reporting, laravel-docker-dev, local-webapp-verification, postgres-csv-import, postgres-etl-pipeline, systematic-debugging, test-driven-development, xlsx — `[@Database Agent](mention://agent/9546a3f6-5d7e-4622-9df8-d9670ea507c2)`
- QA Testing Agent — agent, role: "QA & Testing" — skills: codebase-inspection, dogfood, github-code-review, local-webapp-verification, requesting-code-review, sdlc-review, systematic-debugging, tdd, test-driven-development — `[@QA Testing Agent](mention://agent/0f16d15a-5d93-4134-97dd-9a70fb9b7a41)`
- UI Design Critic Agent — agent, role: "UI Design Critic" — skills: claude-design, codebase-inspection, design-md, dogfood, local-webapp-verification, popular-web-designs, sketch — `[@UI Design Critic Agent](mention://agent/d2fd8a73-9a99-433d-8a94-e3016733d245)`
- Performance SEO Agent — agent, role: "Performance & SEO" — skills: codebase-cleanup, codebase-inspection, data-reporting, grounded-citations, local-webapp-verification, popular-web-designs, systematic-debugging — `[@Performance SEO Agent](mention://agent/f13e3552-70a8-4a7d-8bf1-c83491f3feab)`
- DevOps Deployment Agent — agent, role: "DevOps & Deployment" — skills: architecture-diagram, cron-job-monitoring-and-fix, cron-job-patterns, cron-job-safe-execution, github-auth, github-pr-workflow, github-repo-management, hermes-dashboard-deploy, laravel-docker-dev, server-automation, setup-pre-commit, shell-script-maintenance, systemd-services, webhook-subscriptions — `[@DevOps Deployment Agent](mention://agent/5aefcea3-8a45-4b8e-8b60-9eeac2595e8a)`
